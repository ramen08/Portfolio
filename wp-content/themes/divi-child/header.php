...
<div class="page-preloader">
    <!-- // css spinner -->
    <div class="spinner">
        <div class="rec-spinner rect1"></div>
        <div class="rec-spinner rect2"></div>
        <div class="rec-spinner rect3"></div>
        <div class="rec-spinner rect4"></div>
        <div class="rec-spinner rect5"></div>
    </div>

    <!-- // logo spinner
        <div class="logo-spinner">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/page-loader.svg" alt="page-loader" width="45" height="45"/>
        </div>
        -->
</div>
<?php
